...
const plans = [
  {
    name: "Essential",
    price: "From $2,500/mo",
    description: "Stabilize and optimize IT for small-to-midsize businesses.",
    features: [
  ...
  },
  {
    ...
    description: "Enterprise-grade IT, custom development, & strategic leadership.",
    features: [
...
const ServicePlansPage = () => (
  <section className="py-16 lg:py-24 bg-navy/85 min-h-screen">
    <div className="container mx-auto px-4">
      <div className="text-center mb-16">
        <h2 className="text-4xl lg:text-5xl font-poppins font-bold text-gradient-yellow-end mb-6 drop-shadow-header">
          Service Plans: Essential, Premier & Elite
        </h2>
        <p className="text-xl text-white/80 max-w-3xl mx-auto">
          Compare our flexible plans—all backed by our 6-week ROI guarantee.
        </p>
      </div>
          ...
          >
            ...
            <CardContent className="pt-0">
              ...
              <Button 
                ...
                size="lg"
              >
                {plan.name === "Elite" ? "Contact Us" : "Book Free Assessment"}
              </Button>
            </CardContent>
          </Card>
        ))}
