...
import { Settings, Users, Utensils, FileText } from 'lucide-react';
import { Link } from 'react-router-dom';

const clientData = [
  {
    icon: Settings, // Use 'Settings' instead of invalid 'Gear'
  ...
  },
  {
    ...
    description:
      "Finance executives aiming to optimize spend, reduce IT noise, and deploy real-time dashboards and advanced analytics for truly data-driven decisions.",
  ...
  },
  {
    ...
    description:
      "Multi-site, compliance-focused food and beverage companies needing secure, automated workflows and modern regulatory reporting that scales.",
  ...
  },
  {
    ...
    description:
      "Professional offices seeking vendor consolidation, automation, and secure remote IT workflows to meet evolving client & compliance demands.",
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {clientData.map((client, idx) => {
            ...
            return (
              ...
              >
                <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm h-full flex flex-col">
                  <CardContent className="p-6 flex flex-col flex-1">
                    <div>
                      <div className="w-16 h-16 bg-gradient-yellow rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                        {Icon && <Icon className="w-8 h-8 text-navy" />}
                      </div>
                    ...
                    {/* Yellow highlight badge, aligned at the bottom */}
